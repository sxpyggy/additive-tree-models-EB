...
matplot(1:length(bst_model$train_loss), cbind(bst_model$train_loss, bst_model$valid_loss), type="l",xlab = "boosting iterations", ylab="loss", col=c("black","black"), lty=c(1,2), lwd=1.5,ylim=ylim_0, main="trace plot of loss by training f")
abline(v=which.min(bst_model$valid_loss), lty=2, col="black")
abline(h=c(bst_m_test_loss,glm_null_test_loss),lty=3:4,col=c("blue","red"))
legend("topright",c("training loss","validation loss","test loss", "test loss of null model"), col=c("black","black","blue","red"), lty=1:4, lwd=1)
if (draw_figure==T) dev.off()
...
matplot(1:length(bst_model$train_loss), cbind(bst_model$train_loss, bst_model$valid_loss), type="l",xlab = "boosting iterations", ylab="loss", col=c("black","black"), lty=c(1,2), lwd=1.5,ylim=ylim_0, main="trace plot of loss by training g")
abline(v=which.min(bst_model$valid_loss), lty=2, col="black")
abline(h=c(bst_m_p_test_loss,glm_null_test_loss),lty=3:4,col=c("blue","red"))
legend("topright",c("training loss","validation loss","test loss", "test loss of null model"), col=c("black","black","blue","red"), lty=1:4, lwd=1)
if (draw_figure==T) dev.off()
```
...
true_test_loss
### test mse
dat_test$bst_mu5 <- apply((dat_test[, vname2("bst_mu",K)]*dat_test[, vname2("bst_p",K)]),1,sum) 
(bst_p_test_mse<-mean((dat_test$Y-dat_test$bst_mu5)^2))
bst_m_p_test_mse
glm_null_test_mse
true_test_mse
bst_p$sigma
...
matplot(1:length(bst_model$train_loss), cbind(bst_model$train_loss, bst_model$valid_loss), type="l",xlab = "boosting iterations", ylab="loss", col=c("black","black"), lty=c(1,2), lwd=1.5,ylim=ylim_0, main="trace plot of loss by training g")
abline(v=which.min(bst_model$valid_loss), lty=2, col="black")
abline(h=c(bst_p_test_loss,glm_null_test_loss),lty=3:4,col=c("blue","red"))
legend("topright",c("training loss","validation loss","test loss", "test loss of null model"), col=c("black","black","blue","red"), lty=1:4, lwd=1)
if (draw_figure==T) dev.off()
...
true_test_loss
### test mse
dat_test$bst_mu3 <- apply((dat_test[, vname2("bst_mu",K)]*dat_test[, vname2("bst_p",K)]),1,sum) 
(bst_p_test_mse3<-mean((dat_test$Y-dat_test$bst_mu3)^2))
bst_m_p_test_mse
bst_p_test_mse
glm_null_test_mse
true_test_mse
...
# Save results
```{r}
cor_pearson<-round(cor(dat_test[,c("true_mu","bst_mu5","bst_mu3","bst_mu","bst_mu0","glm_mu", "glm_mu0")])[1,-1],4)
cor_kendall<-round(cor(dat_test[,c("true_mu","bst_mu5","bst_mu3","bst_mu", "bst_mu0","glm_mu","glm_mu0")],method = "kendall")[1,-1],4)
cor_spearman<-round(cor(dat_test[,c("true_mu","bst_mu5","bst_mu3","bst_mu", "bst_mu0","glm_mu","glm_mu0")], method ="spearman")[1,-1],4)
